...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class SendButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), query, resultTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queryEditText = (EditText)findViewById(R.id.client_req_edit_text);
        sendButton = (Button)findViewById(R.id.send_button);
        sendButton.setOnClickListener(sendButtonClickListener);
        resultTextView = (TextView)findViewById(R.id.client_result_text_view);
    }
